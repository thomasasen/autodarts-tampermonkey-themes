...
- [🧩 Skripte](#skripte)
  ...
  - [🎬 Animationen](#animationen)
    ...
    - [Animation: Autodarts Animate Cam Zoom WM Style](#animation-autodarts-animate-cam-zoom-wm-style)
...
#### Animation: Autodarts Animate Cam Zoom WM Style

- Bezeichnung: Autodarts Animate Cam Zoom WM Style
- Datei: `Animation/Autodarts Animate Cam Zoom WM Style.user.js`

[![Installieren](https://img.shields.io/badge/Installieren-Tampermonkey-2ea44f?style=for-the-badge)](https://github.com/thomasasen/autodarts-tampermonkey-themes/raw/refs/heads/main/Animation/Autodarts%20Animate%20Cam%20Zoom%20WM%20Style.user.js)
...
| Variable                  | Standard                    | Wirkung                                                                 |
| :------------------------ | :-------------------------- | :---------------------------------------------------------------------- |
| `CONFIG.requireX01`       | `true`                      | Aktiviert die Lupe nur in X01.                                          |
| `CONFIG.zoomMode`         | `lens`                      | `lens` (Lupe) oder `transform` (Board-Transform).                       |
| `CONFIG.zoomMultiplier`   | `1.7`                       | Globaler Zoom-Faktor für Checkout/T20.                                  |
...
| `CONFIG.lensGlowColor`    | `rgba(190, 255, 140, 1)`    | Glow-Farbe der Lupe.                                                    |
| `CONFIG.lensZIndex`       | `150`                       | Stacking-Order; kleiner als GIF-Overlay (`z-[180]`) hält die Lupe unten. |

##### 🖼️ Beispiele/Screenshots

![Cam Zoom Checkout](assets/Cam%20Zoom%20Checkout.png)
![Cam Zoom t20](assets/Cam%20Zoom%20t20.png)
