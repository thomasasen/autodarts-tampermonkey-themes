...
// @grant        none
// @downloadURL  https://raw.githubusercontent.com/thomasasen/autodarts-tampermonkey-themes/main/Animation/Autodarts%20Animate%20TV%20Board%20Zoom%20Beta.user.js
// @updateURL    https://raw.githubusercontent.com/thomasasen/autodarts-tampermonkey-themes/main/Animation/Autodarts%20Animate%20TV%20Board%20Zoom%20Beta.user.js
// ==/UserScript==
...
`;
  ...
  function applyZoom(zoomTarget, host, transform, signature, zoomIntent) {
    ...
    if (gsapLib && typeof gsapLib.to === "function") {
      const tween = gsapLib.to(zoomTarget, {
        duration: Math.max(0.06, CONFIG.zoomInMs / 1000),
  ...
  function resetZoom(options = {}) {
    ...
    if (gsapLib && typeof gsapLib.to === "function") {
      const baseTransform = getBaseTransform(zoomTarget) || "none";
      stopActiveZoomTween(zoomTarget);
