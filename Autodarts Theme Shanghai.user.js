// ==UserScript==
// @name         Autodarts Shanghai Theme (skvarel)
// @namespace    https://github.com/thomasasen/autodarts_tempermonkey_skripts
// @version      1.0
// @description  Apply the skvarel styling to Autodarts matches when playing Shanghai. Auto-enables for Shanghai, refreshes after DOM/URL changes, and reuses autodartsdesign.js when present. Based on inventwo Autodarts-Stylebot v1.1.0 (MIT).
// @author       Thomas Asen
// @license      MIT
...
(function () {
  ...
  // Fallback styles used if autodartsdesign.js is not present.
